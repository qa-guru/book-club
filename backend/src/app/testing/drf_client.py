...
class ApiClient(DRFAPIClient):
    ...
    def __init__(self, user: User | None = None, *args, **kwargs) -> None:  # type: ignore[no-untyped-def]
    ...
    def _request(self, method, expected, *args, **kwargs):  # type: ignore[no-untyped-def]
    ...
    def _decode(self, response: Response):  # type: ignore[no-untyped-def]
